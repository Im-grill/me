    ...
    <div className="relative">
      ...
      <div className="relative -mt-16 px-4">
        <div className="flex items-end gap-4">
          {/* Avatar */}
          <div className="relative">
            <div className="w-28 h-28 md:w-32 md:h-32 rounded-full overflow-hidden avatar-ring bg-card">
              <img
                src={avatarUrl}
                alt={displayName}
                className="w-full h-full object-cover"
          ...
          {/* Info Card */}
          <div className="flex-1 bg-card/90 backdrop-blur-sm rounded-xl p-4 shadow-soft flex items-center justify-between mb-2">
            <div>
        ...
        {/* Stats */}
        <div className="flex items-center gap-6 mt-4 pl-36">
